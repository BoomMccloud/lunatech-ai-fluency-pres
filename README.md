...
1. Create a new GitHub repository (e.g. `ai-chauffeur-deck`) and upload these files (`index.html` must be at the repo root).
2. In the repo, go to **Settings → Pages**.
3. Under **Build and deployment → Source**, choose **Deploy from a branch**.
4. Select branch **main** and folder **/ (root)**, then **Save**.
5. Wait ~1 minute. Your deck will be live at:
   `https://<your-username>.github.io/<repo-name>/`

## Edit the content

Open `index.html` in any text editor. Each slide is a `<section class="slide">` block; the bottom bar on each is either a `takeaway` or a purple `takeaway task` (an audience activity).
